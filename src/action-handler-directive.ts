...
customElements.define('action-handler-air-purifier', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-air-purifier')) {
    return body.querySelector('action-handler-air-purifier') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-air-purifier');
